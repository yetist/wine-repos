...
function install()
    ...
    os.execute('cp x86_microsoft-windows-directshow-core_31bf3856ad364e35_6.1.7601.17514_none_a877a1cc4c284497/quartz.dll '.. wb.var.system32_dlls)
    wb.wine(wb.var.system32_dlls .."/regsvr32.exe quartz.dll")

    if wb.var.arch == 'win64' then
      file = 'amd64_microsoft-windows-directshow-core_31bf3856ad364e35_6.1.7601.17514_none_04963d500485b5cd/quartz.dll'
      os.execute('cabextract -L -F '.. file ..' '.. wb.var.cache_dir ..'/windows6.1-KB976932-X64.exe')
      os.execute('cp amd64_microsoft-windows-directshow-core_31bf3856ad364e35_6.1.7601.17514_none_04963d500485b5cd/quartz.dll '.. wb.var.system64_dlls)
...
function check()
  ret, text = wb.wine("reg QUERY \"HKEY_CURRENT_USER\\Software\\Wine\\DllOverrides\" /v quartz")
  if ret ~= 0 then
    return false
  end
